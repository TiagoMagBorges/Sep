  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center opacity-0 group-hover:opacity-100 transition-opacity gap-1">
                      ...
                      <Button
                        ...
                        size="icon"
                        className="size-8"
                        onClick={(e) => { e.preventDefault(); e.stopPropagation(); setStudentToDelete(student); }}
                      >
      ...
      <Dialog open={!!studentToDelete} onOpenChange={(open) => !open && setStudentToDelete(null)}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Confirmar exclusão de aluno</DialogTitle>
            <DialogDescription>
              Tem certeza que deseja inativar o aluno <strong>{studentToDelete?.name}</strong>?
              O registro e seu histórico não serão apagados imediatamente, permanecendo retidos em arquivo morto por um período de 2 anos antes da exclusão física.
            </DialogDescription>
          </DialogHeader>
